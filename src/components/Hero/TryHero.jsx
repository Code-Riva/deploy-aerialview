...
const TryHero = () => {
    React.useEffect(() => {
        ...
        gradient.initGradient("#gradient-canvas"); // Initialize the gradient on the canvas element
    }, []);
    ...
    return (
        <>
            ...
            {/* Main Content */}
            <main className="bg-transparent dark:bg-transparent text-black dark:text-white duration-300">
                <div className="container min-h-[620px] flex mt-10 sm:mt-0">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 place-items-center">
                        ...
                        <div className="order-1 sm:order-2 relative" data-aos="zoom-in">
                            ...
                            <div
                                className="absolute text-white -bottom-4 -right-2 bg-gray-900 dark:bg-gray-100 dark:text-black p-2 rounded-xl shadow-lg sm:-right-4 sm:-bottom-5"
                                data-aos="slide-right"
                                data-aos-delay="300"
                            >
                                <p>🗺️ Map Production</p>
                                <h1 className="font-bold">
                                    410000+ <span className="font-normal">Hektares</span>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div className="space-y-5 order-2 sm:order-1 xl:pr-40">
                            <h1 data-aos="fade-up" className="text-4xl sm:text-5xl font-semibold">
                                Mapping area easier using{" "}
                                <span className="text-primary">AerialView</span>
                            </h1>

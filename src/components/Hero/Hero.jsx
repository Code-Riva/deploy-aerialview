...
const Hero = () => {
    return (
    <>
    <main className="bg-gray-100 dark:bg-gray-950 dark:text-white duration-300">
        <div className="container min-h-[620px] flex mt-10 sm:mt-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 place-items-center">
                ...
                <div className='space-y-5 order-2 sm:order-1 xl:pr-40'>
                    <h1 data-aos="fade-up" className='text-4xl sm:text-5xl font-semibold'>Mapping area easier using {" "} <span className='text-primary'>AerialView</span>
                    </h1>
